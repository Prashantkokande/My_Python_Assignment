...
'''
# we can write above code with functions and range
...
def Increment_decrement():
    ...
    for _ in range(Value):
        increment_value += 1
        print(f"The value in increment is {increment_value}")
        
    for _ in range(decrement_value):
        decrement_value -= 1
        print(f"The value in decrement is {decrement_value}")
